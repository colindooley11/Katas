...
using NinetyNineBottles;
using NUnit.Framework;

namespace KataTests.NinetyNineBottlesSingerTests
{
    [TestFixture]
    public class NinetyNineBottlesTests
    {
        [Test]
        ...
        [Test]
        public void Test_A_Couple_Of_Verses()
        {
            var subject = new NinetyNineBottlesSinger();
            var result = subject.Verses(99, 98);
